...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/KeeMarSoTrash/lastui/main/Ung.lua"))()
...
local RCX_Window = Library.NewWindow("KeeMar Hub|GARENA FREEFIRE MAX", {window_size = V3(RCX.UI.Window_Size.X, RCX.UI.Window_Size.Y), window_size_func = function(new_ui_size)
...
end, {default = Enum.KeyCode.RightControl})
